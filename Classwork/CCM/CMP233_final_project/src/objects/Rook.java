...
public class Rook extends Piece{
	...
	//Declare fields
	private static String pieceName = "R";
	 ...
	 */
	Rook(String color, int iteration, boolean promotion) {
		...
		if (!promotion) {
			...
			if (iteration == 1) {
				...
				startingPos = "a-" + startingPos;
				
			} else {
				
				startingPos = "h-" + startingPos;
